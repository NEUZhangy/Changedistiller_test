...
public class Util {
    ...
    public void addStmtToDiff(DiffType diff, Map<Range, Expression> stmts, CompilationUnit cu) {
...
//                .forEach(x -> stmtMap.put(x.getRange().get(), x.getExpression()));
    ...
    public HashMap<Range, Range> getMatchStmts(
        ...
        Map<Range, String> leftStmts = normalizeStmts(leftCU, left, true);
        Map<Range, String> rightStmts = normalizeStmts(rightCU, right, true);
    ...
    public Map<Range, String> normalizeStmts(
            CompilationUnit cu, Map<Range, Expression> lineMap, boolean isArgumentNormalized) {
    ...
    public Map<Range, String> normalizeStmtsWithArguments(
            CompilationUnit cu, Map<Range, Expression> lineMap) {
        Map<String, String> paramMap = new HashMap<>();
        Map<String, String> varList = new HashMap<>();
        Deque<Integer> st = new ArrayDeque<Integer>();
        int count = 0;
